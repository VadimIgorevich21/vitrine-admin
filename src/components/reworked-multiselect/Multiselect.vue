<template>
  <div
    ...
    class="multiselect public-sans-fonts"
    role="combobox"
  ...
  >
    ...
    <div ref="tags" class="multiselect__tags">
      ...
      <span
        ...
        class="multiselect__single truncate"
      ...
      <svg
        v-if="isSingleLabelVisible && cleanable"
        version="1.1"
        ...
        @keypress.enter.prevent="onClickClear()"
        @mousedown.prevent="onClickClear()"
      >
        <path
      ...
      >
        <div ref="itemsList">
          ...
          >
            ...
            >
              <span class="multiselect__option">
                <slot name="noResult" :search="search">Нет результатов</slot>
              </span>
            </li>
            <li
              v-show="
