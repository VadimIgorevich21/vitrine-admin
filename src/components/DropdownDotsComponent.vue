<template>
  <div
    ...
    class="dropdown-dots-menu text-gray-500 dark:text-gray-400 mr-[20px]"
  >
    <div class="text-left">
...
export default {
  ...
  created() {
    ...
    document.getElementById("body-scroll").addEventListener("scroll", () => {
      if (this.isOpen) {
        this.isOpen = false;
        this.$forceUpdate();
      }
